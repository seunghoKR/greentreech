<div class="py-12 px-4 sm:px-6 lg:px-8 max-w-xl mx-auto">
    ...
    <div class="bg-white rounded-3xl border border-outline-variant/40 shadow-soft p-6 sm:p-10 space-y-6">
        ...
        <form action="/auth/profile" method="POST" class="space-y-5">
            ...
            <!-- Real Name -->
            <div>
                <label class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-1.5">성함 (실명)</label>
                <input 
                    type="text" 
                    name="name" 
                    value="<?= e($member['name'] ?? '') ?>" 
            ...
            <!-- Nickname -->
            <div>
                <label class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-1.5">활동 닉네임 <span class="text-red-500">*</span></label>
                <input 
                    type="text" 
                    name="nickname" 
            ...
            <!-- Phone -->
            <div>
                <label class="block text-xs font-bold text-gray-700 uppercase tracking-wider mb-1.5">연락처 (휴대폰 번호)</label>
                <input 
                    type="tel" 
                    name="phone" 
